...
function LandingPage() {
  ...
  return (
    <div className="insuffle-landing">
      {/* Noise overlay - effet grain pour texture "table de travail" */}
      <div className="noise-overlay"></div>

      {/* HERO SECTION - Full height, Post-its flottants */}
      ...
      {/* BANDEAU ALERTE SYMPTÔMES - Marquee jaune -rotate-2 */}
      ...
      {/* DATA SECTION - 4 blocs avec compteurs animés */}
      ...
      {/* BANDEAU CLIENTS - Marquee bleu -rotate-2 */}
      ...
      {/* CONSTAT SECTION - Split layout avec verbatims post-it */}
      ...
      {/* PILIER COMPLEXITÉ - 3 blocs avec bordures colorées */}
      ...
      {/* BOUSSOLE 4C - Système Radar avec balayage animé */}
      ...
      {/* MODÈLE ODCT - Sticky Stack avec timeline */}
      ...
      {/* OFFRES - Les 3 Portes avec hover reveal */}
      ...
      {/* CTA FINAL - Monolithe avec scan light */}
